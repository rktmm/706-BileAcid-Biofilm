...
export HUMANN_CONFIG_FOLDER=/mnt/data-disk/tmp_scratch/database/humann4_db # this is the specific location of db used
humann_config --print

# for this particular analysis - it has been run in batches - therefore collate all tsv files into one folder
# file locations
#   ~/gcsfuse/"$project_id_out_bucket"/evette-humann-analysis/humann4_out-batch-00*/
...
-exec cp -n -v -t ~/gcsfuse/"$project_id_out_bucket"/evette-humann-analysis/hmn4_collated_out/ {} +
